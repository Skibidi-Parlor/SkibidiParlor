...
export const userRouter = router({
  ...
  create: publicProcedure
    ...
    .mutation(async (opts) => {
      ...
      const user = await db.query(`INSERT INTO user_account(username, nickname, email, passwordHash, pfp_path) VALUES ($1, $2, $3, $4, $5) RETURNING id`, [username, nickname, email, hashedPassword, pfp_path]);
      return user;
    }),
})
