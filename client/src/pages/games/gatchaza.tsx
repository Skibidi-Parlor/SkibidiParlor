    ...
    return (
        <>
            <div className="w-[100vw] h-[100vh] bg-[#c85252] flex flex-col items-center justify-center overflow-clip relative">
                <div>
                    <button className="bg-white rounded-2xl px-2 py-2 "onClick={() => navigate("/games")}>
                        Back to Menu
                    </button>
                    <button className="ml-3 bg-white rounded-2xl px-2 py-2" onClick={openPizza}>
                        Pizza Collection
                    </button>
                </div>
                ...
                {!howToPlay && (
                    <div className="bg-white p-5 rounded-4xl absolute z-2 text-center pt-5">
                        ...
                        <p>Depending on the Rarity, you'll receive a # of points that'll be added to your score</p>
                        ...
                        <button className="py-2 px-5 mt-5 rounded-2xl bg-[#FFE49A] hover:bg-[#FFE49A]" onClick={startGame}>
                            Close
                        </button>
                    </div>
                )}
                ...
                {pizzaCollection && (
                    <div className="z-5 bg-white absolute p-4 rounded-3xl text-center">
                        ...
                        <button className="py-2 px-5 mt-5 rounded-2xl bg-[#FFE49A] hover:bg-[#FFE49A]" onClick={closePizza}>
                            Close
                        </button>
                    </div>
