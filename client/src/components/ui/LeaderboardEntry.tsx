...
function LeaderboardEntry(props: {
  ...
  return (
    <div className={`flex w-full px-4 py-3 border border-white shadow-xl rounded-2xl ${backgroundColor}`}>
      <div className="flex flex-col justify-center items-center text-2xl">
        {placing}
      </div>

      <img src={user_pfp} className={"w-10 h-10 lg:w-12 lg:h-12 rounded-full ml-3 mr-2"}></img>

      <div className="flex flex-col w-9/12 mr-2 justify-center px-2 text-lg lg:text-xl">
        {username}
      </div>
